...
void gl_mineral::render() {
    ...
    glBegin(GL_TRIANGLE_STRIP);
    {
        ...
        glColor3f(84.f / 255.f, 211.f / 255.f, 0.0f);
    ...
    glLineWidth(1.0 * get_scale() / 10.f);
...
void gl_mineral::set_scale(GLfloat scale) {
...
GLfloat gl_mineral::x() const {
    return m_x;
}

GLfloat gl_mineral::y() const {
    return m_y;
}
